...
class patio2:
    ...
    def step_6(self):
        ...
        # sleep(15)
        # self.turn(0)
        self.radar_move('F','<',40, 0.0568)
        self.turn(90)

    def step_7(self):
        #self.radar_move("F", "<", self.dis_to_bin, 0.04)
        self.mc.fw(0.8, 0.0248)
...
if __name__ == "__main__":
    ...
    gs = gyroscope()
    hc12 = HC12(RX_pin=9, TX_pin=8, SET_pin=15)
